...
class Puzzle:
    ...
    As such, (0, 0), (0, t-1), and (t-1, 0) are the three corners of the
    ...
    def __init__(self, x=0, y=0):
        ...
        # total number of pegs starts at sum to t
        self.pegs_remaining = t*(t+1)/2
